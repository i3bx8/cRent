 ...
 * @author ELBOSTAN
 */
public class showRenter extends javax.swing.JFrame {
  ...
  read_data();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Show Renter Information");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showRenter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new showRenter().setVisible(true);
            }
        });
    }
  ...
  private void read_data(){
            ...
            File myObj = new File(f+"\\rents.txt");
